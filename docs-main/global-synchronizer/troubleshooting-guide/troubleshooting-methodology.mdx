...
This section provides an overview of which information can be collected to debug issues in a Canton Network node. For direct console access to a Canton node, see the [Console Access](/global-synchronizer/production-operations/console-access).
