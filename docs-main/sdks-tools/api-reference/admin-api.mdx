...
Canton extends the standard Ledger API admin services with operations specific to Canton's architecture. Access these through the [Canton Console](/global-synchronizer/production-operations/console-access) or directly via gRPC.
...
<CardGroup cols={2}>
  ...
  <Card title="Console Access" href="/global-synchronizer/production-operations/console-access">
