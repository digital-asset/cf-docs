...
2. Enter the registry URL and the admin party associated with the registry, then click **Add**.
   ...
   ![Form for entering a registry URL and admin party](/images/sdks-tools/splice-portfolio/registry-add-form.png)

3. View and delete registries in the **Registries** section.

   ![Registries listed in the Settings page](/images/sdks-tools/splice-portfolio/settings.png)
